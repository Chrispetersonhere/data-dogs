...
export default function ApiReferencePage() {
  return (
    <section>
      ...
      <p style={apiStyles.subtitle}>Endpoint groups, authentication model, request/response schemas, and provenance guarantees will be documented here.</p>
      <div style={apiStyles.placeholder}>Placeholder: detailed endpoint documentation will be added in subsequent daily scopes.</div>
    </section>
  );
}
