    ...
    <main style={shellStyle}>
      <div style={{ maxWidth: '1180px', margin: '0 auto', display: 'grid', gap: spacingTokens['4'] }}>
        <section style={cardStyle}>
          <div className="dd-skeleton" style={{ ...pulseBar, width: '220px', marginBottom: spacingTokens['3'] }} />
          <div className="dd-skeleton" style={{ ...pulseBar, width: '300px', height: spacingTokens['8'] }} />
        </section>
        <section style={cardStyle}>
