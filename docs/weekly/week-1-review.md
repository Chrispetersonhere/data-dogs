...
5. Continue tightening command runbooks, with platform-specific copy/paste verification flows and deterministic Windows install-recovery (including package-level node_modules cleanup) and fresh-clone fallback steps.
